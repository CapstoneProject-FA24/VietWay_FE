export const mockTours = [
  ...
  },
  {
    ...
    destinationProvince: "Kiên Giang",
    days: 5,
    totalAcceptedParticipants: 30,
...
export const getFilteredTours = (filters, sortBy) => {
  ...
  if (filters.destinationProvince) {
    filteredTours = filteredTours.filter(tour => tour.destinationProvince === filters.destinationProvince);
  }
  if (filters.minPrice) {
